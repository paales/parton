...
| `TAILWIND_SHADCN_MIGRATION.md` | 2026-04-23 status log for the Tailwind v4 + shadcn/ui refactor — what landed, what broke, the flaky-specs list, the frame-scope fingerprint drift diagnosis. Archived 2026-04-24: refactor settled and the load-bearing findings (frame-scope drift fix, `isTestMode()`) moved into `../notes/FRAME_SCOPING.md` and `../notes/SERVER_ISOLATION.md` respectively. Kept here for the debugging trail. |
