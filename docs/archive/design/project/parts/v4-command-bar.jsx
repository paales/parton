  ...
  return (
    <div style={{ position:'relative', width: W, height: H, background:'#e9e4d8' }}>
      ...
      <div style={{
        ...
        fontFamily:'var(--ui)', fontSize: 12, zIndex: 8,
      }}>
        <div style={{ display:'flex', alignItems:'center', gap: 6 }}>
          <div style={{ width: 14, height: 14, borderRadius:3, border:'1.5px solid var(--paper)' }} />
          <span style={{ opacity: 0.6 }}>home</span>
          <span style={{ opacity: 0.4 }}>›</span>
          <span>hero</span>
        </div>
        <div style={{ flex: 1, height: 26, borderRadius: 6, background:'rgba(255,255,255,0.08)',
      ...
      <div style={{
        position:'absolute', right: 60, top: 200, width: 300,
        background:'rgba(255,255,255,0.97)',
        border:'1px solid rgba(0,0,0,0.12)', borderRadius: 10,
        boxShadow:'0 14px 36px rgba(0,0,0,0.16)',
        padding: 14, fontFamily:'var(--ui)', fontSize: 12,
        zIndex: 6,
      }}>
        ...
        <div style={{
          position:'relative', height: 130, marginBottom: 14,
          background: '#fff', border:'1px solid rgba(0,0,0,0.1)', borderRadius: 6,
        }}>
          <div className="stripes-margin" style={{ position:'absolute', inset: 8, borderRadius:4 }} />
          <div className="stripes-padding" style={{ position:'absolute', inset: 22, borderRadius:4 }} />
          <div style={{ position:'absolute', inset: 38, outline:'1.5px dashed var(--insp-blue-strong)',
                       background:'rgba(108,177,240,0.18)',
                       display:'grid', gridTemplateColumns:'repeat(4,1fr)', gap: 4, padding: 4 }}>
            {[0,1,2,3].map(i => <div key={i} style={{ background:'rgba(0,0,0,0.08)', borderRadius: 2 }} />)}
          </div>
          {/* spacing labels */}
          {[
            ...
            <div key={i} className="mono" style={{
              position:'absolute', ...p, fontSize: 9.5, color:'var(--ink-2)',
              background:'#fff', padding:'1px 3px', borderRadius:2,
            }}>{p.t}</div>
          ))}
        </div>
        ...
        <div style={{ display:'flex', gap: 6, flexWrap:'wrap' }}>
          {['cols 4','gap 16','full','center','color','m 0/80'].map((c, i) => (
            <div key={i} className="mono" style={{
              ...
              border:'1px solid rgba(0,0,0,0.18)', borderRadius: 5,
              background:'#fff',
            }}>{c}</div>
          ))}
        </div>
      ...
      <div style={{
        ...
        <div style={{
          height: 1, width: 380, background:'var(--insp-blue-strong)',
          opacity: 0.4,
        }} />
        <div style={{
        ...
        <div style={{ height: 1, width: 380, background:'var(--insp-blue-strong)', opacity: 0.4 }} />
      </div>

      <Annotation x={30} y={H - 50} w={400}
