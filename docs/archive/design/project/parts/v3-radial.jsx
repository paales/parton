  ...
  return (
    <div style={{ position:'relative', width: W, height: H, background:'#e9e4d8' }}>
      ...
      <div style={{ position:'absolute', left: 0, top: 70, pointerEvents:'none' }}>
        <SelectionRect width={W} height={300} margin={0} padding={20} showMargin={false}
          label={{ tag:'section', cls:'hero' }} dim={`${W} × 300`} />
      </div>
      ...
      <div style={{
        position:'absolute', left: 30, top: 380,
        width: 540, padding: 12,
        ...
        <div style={{
          position:'absolute', left: 80, top: -10, width: 2, height: 10,
          background: 'var(--insp-blue-strong)',
        }} />
        <div style={{ position:'absolute', left: 76, top: -12,
          width: 10, height: 10, borderRadius: '50%', border:'2px solid var(--insp-blue-strong)', background:'#fff' }} />

        <div style={{ display:'flex', alignItems:'center', gap: 8, marginBottom: 10 }}>
          <InspectorTag tag="section" cls="hero" dim="1100 × 300" />
          <div style={{ flex: 1 }} />
          <div className="mono" style={{ fontSize: 10, color:'var(--ink-3)' }}>esc to dismiss</div>
        </div>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr 1fr', gap: 12 }}>
          ...
          <div>
            ...
            <Row label="Pad" hint="80"><div className="wf-slider" /></Row>
          </div>
          <div>
            <SectionHead>Background</SectionHead>
            <Row label="Type"><div className="wf-segment"><div className="on">Color</div><div>Img</div></div></Row>
            <Row label="Color"><div style={{ display:'flex', gap:6 }}>
              <div style={{ width:18,height:18,background:'#d9d4c5',borderRadius:4,border:'1px solid var(--line)' }} />
      ...
      <div style={{
        ...
        borderRadius: 8, height: 30, padding:'0 4px',
        display:'flex', alignItems:'center', gap: 0,
        fontFamily:'var(--mono)', fontSize: 11,
        boxShadow:'0 8px 20px rgba(0,0,0,0.2)', zIndex: 7,
      }}>
        {['body','main','section.hero','div.container','h1'].map((c, i, arr) => (
          <React.Fragment key={i}>
            <div style={{
              padding:'0 8px', height: 22, display:'flex', alignItems:'center',
              borderRadius: 4,
  ...
  return (
    <div style={{ position:'relative', width: 130, height: 130 }}>
      ...
      <div style={{
        ...
        border:'1px dashed rgba(0,0,0,0.2)', borderRadius:'50%',
      }} />
      {items.map((it, i) => {
