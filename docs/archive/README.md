...
| [`channel-design.md`](./channel-design.md) | [`internals/channel.md`](../internals/channel.md) (frames, envelopes, delivery seqs, the attach) + [`internals/streaming.md`](../internals/streaming.md). The note keeps the bet, the invariant's rationale, and the landing sequence. Archived 2026-07-18. |
| [`one-stream-transport.md`](./one-stream-transport.md) | [`internals/channel.md`](../internals/channel.md) — every package landed (bounded re-establishment, boot-attach navs, keepalive backstop, body-less actions, cookies on the protocol, transport seam + WebSocket + auto-upgrade, WebTransport). The note keeps the survey findings. Archived 2026-07-18. |
| [`wake-index.md`](./wake-index.md) | [`internals/registry-internals.md`](../internals/registry-internals.md) § the inverted wake index + [`internals/streaming.md`](../internals/streaming.md). W1/W2 landed; W3 shipped as broadcast lanes ([`../notes/delivery-plane.md`](../notes/delivery-plane.md) §D2). Archived 2026-07-18. |
| [`leases.md`](./leases.md) | [`../notes/delivery-plane.md`](../notes/delivery-plane.md) (the follow-on) + [`internals/registry-internals.md`](../internals/registry-internals.md) § Persistence / eviction / restore (L2). L1/L2 landed; the producer-lease primitive stays deferred pending a real non-derivable caller. Archived 2026-07-18. |
...
| [`deploy-and-drain.md`](./deploy-and-drain.md) | [`../reference/deployment.md`](../reference/deployment.md) § Drain — the operator contract; the note keeps the SIGTERM-as-protocol design rationale + as-built map. Mechanism in [`../internals/channel.md`](../internals/channel.md) § Deploy-and-drain.                                                                                                                                 |
| [`bridge-seam.md`](./bridge-seam.md)           | [`../reference/deployment.md`](../reference/deployment.md) § Multi-process — `setInvalidationBridge`; the note keeps the cross-process consistency-contract rationale + the failover/drain measurements. Mechanism in [`../internals/registry-internals.md`](../internals/registry-internals.md) § The bridge seam.                                                                       |
| [`view-culling.md`](./view-culling.md)         | [`../reference/partial.md`](../reference/partial.md) § View culling — the cull gate + [`../internals/render-pipeline.md`](../internals/render-pipeline.md) § Cull-to-park. The note keeps the original tracked-read design and the framework-level findings — the substrate for a future `<Scroller>`. Archived 2026-07-18.                                                              |
| [`cells-as-resolvers.md`](./cells-as-resolvers.md) | [`../reference/cells.md`](../reference/cells.md) + [`../internals/cell-internals.md`](../internals/cell-internals.md). The 2026-05-26 design-pass retro; the still-open residues (declarative mutation writes, object/list shapes, adapter eviction) are backlog-shaped. Archived 2026-07-18.                                                                                        |
| [`cell-dimensionality.md`](./cell-dimensionality.md) | [`../reference/cells.md`](../reference/cells.md) — the shipped one-value-per-partition surface. The inheritance-walk axis never earned a caller; tracked from [`../notes/IDEAS.md`](../notes/IDEAS.md) § i18n. Archived 2026-07-18.                                                                                                                                                  |
| [`replicated-state.md`](./replicated-state.md) | [`../reference/cells.md`](../reference/cells.md) + [`../internals/cell-internals.md`](../internals/cell-internals.md) — cells, `useOptimistic`, and `cell.update` cover the Unreal-derived authority taxonomy. Predecessor: [`transient-client-state.md`](./transient-client-state.md). Archived 2026-07-18.                                                                          |

## Reference material (not code-bound)

| Path                                                 | Purpose                                                                                                                                                                                                                                                                          |
| ---------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `design/`                                            | V6 floating block editor design bundle — Claude Design conversation (`chats/chat1.md`), V6 prototype (`project/`), screenshots (`v6-screenshots/`, `live/`), Playwright drivers. Implementation lives in `cms/src/editor/`; this directory captures the _why_ behind the chrome. |
...
- [`proxy-design/`](./proxy-design/) — the legacy proxy data layer
  (where field access _was_ the query). Not wired into the app; kept
  for reference.
