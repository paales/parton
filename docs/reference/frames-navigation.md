...
| `scroll: "manual"` | An IN-PLACE navigation: the refetch runs as usual, but the browser's default post-transition scroll (to top) is suppressed — for navigations that DESCRIBE the position the user already occupies (a scroller's window statement, any scroll-position projection). Without it, the deferred default scroll waits out a live scroll gesture and teleports the viewport the moment the gesture stops. `navigate`-only.                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
