...
| [`task-settle.md`](./task-settle.md) | Per-parton subtree settlement — the Flight task lifecycle's task-done moments, the settle-scope refcount shipped in the vendored-server patch (`_onPartonSettled`), and the incremental-trailer / segment-gating consumers it unlocks. |
