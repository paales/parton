...
| [`research-to-poc.md`](./research-to-poc.md)             | The research→PoC bar and its five gating workstreams with exit criteria.                                                                                                                                                                                    |
| [`convergence-fuzzing.md`](./convergence-fuzzing.md)     | The convergence oracle, the v1/v2 fuzz harnesses, and the FINDINGS LEDGER (F1–F13) that framework code and tests cite — load-bearing documentation of a shipped harness.                                                                                    |
...
| [`AA_CHAT_STREAMING.md`](./AA_CHAT_STREAMING.md)         | Demo content for the chat overlay (the file the streaming-chat demo seeds first). Not a design doc — the chat producer resolves basenames against `docs/{notes,reference,internals,archive}`.                                                               |
