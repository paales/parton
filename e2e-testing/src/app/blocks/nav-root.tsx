 ...
 * nav-item blocks. Singleton block whose CMS storage key falls out of
 * the spec's id: `AppNavRender` derives the type `"app-nav"`, which is
 * both the catalog id and the row in `content.json` the schema reads
 * from.
 */
