      ...
      <>
        <header className="mb-4" data-testid="rfxd-header">
          ...
          <p className="mt-2 text-xs text-muted-foreground">
            ...
            <code>yarn parton add magento http://localhost:5181</code>. The host renders the typed
            components below; each embeds an ORDINARY page of the <code>e2e-magento</code> dev
            server (<code>/remote/*</code>) as Flight, slices away its document chrome, rewrites
            module references to absolute URLs at the remote's origin, and stitches the body content
            into this response. If you don't see content below, the <code>e2e-magento</code> dev
        ...
        <footer className="mt-4 text-xs text-muted-foreground" data-testid="rfxd-footer">
          Footer rendered at <code>{new Date().toISOString()}</code>. The host paints chrome
          immediately; each cross-origin fetch resolves independently and stitches in via its
          Suspense boundary.
        </footer>
      </>
    )
